...
def generate(rp_id, rp_name, user_id, user_name, user_display_name,
             challenge) -> structs.PublicKeyCredentialCreationOptions:
    return webauthn_opts.generate_registration_options(rp_id=rp_id,
                                                       ...
                                                       supported_pub_key_algs=[
                                                           cose.COSEAlgorithmIdentifier.ECDSA_SHA_512],
                                                       timeout=12000)
